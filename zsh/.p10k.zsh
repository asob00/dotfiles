# Generated by Powerlevel10k configuration wizard on 2021-01-12 at 14:18 CET.
...
# sharp heads, flat tails, 2 lines, dotted, left frame, compact, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=202
  ...
  # prompt if `example` prompt segment is added to OWERLEVEL9K_LEFT_PROMPT_ELEMENTS or
